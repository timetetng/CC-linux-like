...
local host = _HOST or "Unknown Host"
local w, h = term.getSize()
local is_color = term.isColor()
local editor = (function() if shell.resolveProgram("vim") then return "vim" else return "CraftOS-edit" end end)()
local shell = "crash"
...
if is_color then
    ...
    local color_row = {
        colors.gray, colors.white, colors.green, colors.magenta,
        colors.lightBlue, colors.yellow, colors.lime, colors.red
    }
